        ...
        <div className ='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
            <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
                ...
                <div className='flex items-center flex-wrap gap-2 mt-4 '>
                    ...
                    <button onClick={()=>{navigate('/trailers'); scrollTo(0,3)}} className='flex items-center gap-2 px-7 py-3 text-sm bg-gray-800 hover:bg-gray-900 transition rounded-md font-medium cursor-pointer active:scale-95'>
